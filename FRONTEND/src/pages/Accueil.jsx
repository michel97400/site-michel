        ...
        <main className="page-content">
            ...
            <section className="hero">
                <div className="hero-content">
                    ...
                    <div className='hero-assist-container'>
                        <span className="hero-assistant"></span>
                        <span className="hero-assistant">Consulter mon profil ou discuter avec Jarvis mon assistant intelligent pour répondre à vos questions: </span>
                        <a href="/chatbot" className="button_assistant">
                                Mon assistant IA
                        </a>
                    </div>
                    ...
                    <p className="hero-subtitle">
                        ...
                        Passionné par la programmation, je développe, via des projets personnels: des outils automatisés, des chatbots (simples ou alimentés via des RAG), génération d'image, site web évolutif, application d'entreprise etc. Je suis disponible pour créer vos solutions dynamique et évolutive.
                    </p>
                    
                    
                    <div className="hero-buttons">
                        <span className='info-button'>Découvrez mon travail :</span>
                        <a href="https://github.com/michel97400?tab=repositories" target="_blank" rel="noopener noreferrer" className="btn btn-primary">
                        ...
                        <span className='info-button'>Téléchargez mon CV :</span>
                        ...
                        <span className='info-button'>Contactez-moi :</span>
